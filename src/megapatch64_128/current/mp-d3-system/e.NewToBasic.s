...
;Reset-Rotuinen zusammengefasst.
...
:SaveDataRAM		w $8400				;Systemvariablen Teil #1 speichern.
			w R1_ADDR_SYS_VAR1		;$8400 = Start SzsVar#1 in RAM.
			w R1_SIZE_SYS_VAR1		;$7900 = Start SzsVar#1 in REU.
			b $00

			w OS_VAR_MP			;Systemvariablen Teil #2 speichern.
			w OS_VAR_MP-$9d80+$b900		;$9D80 = Start SzsVar#2 in RAM.
			w R3_SIZE_MPVARBUF		;$B900 = Start SzsVar#2 in REU.
			b $00
...
::52			jsr	NewDisk
			...
			lda	sysRAMFlg
			sta	sysFlgCopy
;			and	#$20			;Kann entfallen. MP3 hat immer
;			beq	:55			;eine REU!!!

			ldy	#$00			;Systemvariablen Teil #1 und #2
::53			ldx	#$00			;und Mauszeiger in REU retten.
::54			lda	SaveDataRAM,y
			sta	r0L        ,x
			iny
			inx
			cpx	#$07
