...
if Flag64_128 = TRUE_C128
			lda	#$0f			;Farbe 40 Zeichen für Icon
			bit	graphMode
			bpl	:40
			...
			sta	r0H
			jsr	SetMsePic
			lda	#$0e			;Farbe 80 Zeichen für Icon
::40			sta	ColRegTIcon1_1_01
endif
...
:PrintSpoolMenu		jsr	RegisterSetFont		;8-Punkte-Font aktivieren.
			...
			jsr	FrameRectangle
if Flag64_128 = TRUE_C128
			lda	#$0e			;Farbe 80 Zeichen
			bit	graphMode
			bmi	:80
endif
			lda	#$0f			;Farbe 40 Zeichen
::80			jsr	DirectColor
...
::80a			jsr	DirectColor
			...
			b	$00 ! DOUBLE_B,$01,$0f ! DOUBLE_B,$03,$0d
...
:RegTIcon1_1_01		w Icon_40
			b $1c ! DOUBLE_B,$68,$01 ! DOUBLE_B,$08
