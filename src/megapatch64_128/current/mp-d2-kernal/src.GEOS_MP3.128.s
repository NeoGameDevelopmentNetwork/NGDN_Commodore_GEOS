...
;Diese müssen mit unverändert auch in den RAM-Patches am Anfang stehen.
...
;*** o.DvRAM_RL   $9EE7-$9F54
;*** o.DvRAM_SCPU $9EE7-$9F33
;*** o.DvRAM_CREU $9EE7-$9F4C
;*** o.DvRAM_GRAM $9EE7-$9F33
;******************************************************************************
:BASE_RAM_DRV_SYS	e $9f54
.BASE_RAM_DRV_END
;******************************************************************************
...
;*** Hier muß der größte Wert von 'Patch_BASE_2a' eingetragen werden, welcher
;*** beim Assemblieren mit SCPU = FALSE/TRUE entsteht, damit das SCPU-Patch
;*** auch im Kernal Platz hat!
;*** SCPU = FALSE: $c6bd = $88 Bytes
;Patch_SIZE_SCPU = Patch_BASE_2a - Patch_BASE_2
;*** SCPU = TRUE : $c6fa = $c5 Bytes = Patch_SIZE_SCPU von o.Patch_SCPU
:Patch_SIZE_SCPU = $c5
;******************************************************************************
:_19T			e Patch_BASE_2 + Patch_SIZE_SCPU;$c6fa
:_19
;******************************************************************************
