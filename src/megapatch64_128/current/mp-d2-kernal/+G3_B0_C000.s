...
;Farbtabelle für VDC
;Aufbau wie C_FarbTab in -G3_MP3_VAR
:New_C_FarbTab		;Beginn der Farbtabelle
:_C_Balken		b $05				;Scrollbalken:
:_C_Register		b $0d				;Karteikarten: Aktiv:
:_C_RegisterOff		b $0a				;Karteikarten: Inaktiv:
:_C_RegisterBack	b $0d				;Karteikarten: Hintergrund:
:_C_Mouse		b $02				;Mausfarbe:
:_C_DBoxTitel		b $f0				;Dialogbox: Titel:
:_C_DBoxBack		b $07				;Dialogbox: Hintergrund + Text:
:_C_DBoxDIcon		b $0f				;Dialogbox: System-Icons:
:_C_FBoxTitel		b $f0				;Dateiauswahlbox: Titel:
:_C_FBoxBack		b $03				;Dateiauswahlbox: Hintergrund + Text:
:_C_FBoxDIcon		b $05				;Dateiauswahlbox: System-Icons:
:_C_FBoxFiles		b $07				;Dateiauswahlbox: Dateifenster:
:_C_WinTitel		b $f0				;Fenster: Titel:
:_C_WinBack		b $0e				;Fenster: Hintergrund:
:_C_WinShadow		b $00				;Fenster: Schatten:
:_C_WinIcon		b $05				;Fenster: System-Icons:
:_C_PullDMenu		b $07				;PullDown-Menu:
:_C_InputField		b $0f				;Text-Eingabefeld:
:_C_InputFieldOff	b $0e				;Inaktives Optionsfeld:
:_C_GEOS_BACK		b $1e				;GEOS-Standard: Hintergrund:
:_C_GEOS_FRAME		b $00				;GEOS-Standard: Rahmen:
:_C_GEOS_MOUSE		b $02				;GEOS-Standard: Mauszeiger:
