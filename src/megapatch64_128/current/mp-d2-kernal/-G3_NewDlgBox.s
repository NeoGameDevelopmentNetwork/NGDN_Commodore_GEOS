...
if Flag64_128 = TRUE_C128
			lda	r3H			;Double-Bit für X-Koordinaten
			and	#$80			;ausmaskieren
			sta	DB_DblBit		;und in Flag sichern
endif
...
if Flag64_128 = TRUE_C128
			ldy	#$04			;Bit7 = Double-Bit in X
			lda	(r5L),y			;der Icons setzen
			ora	DB_DblBit
			sta	(r5L),y
endif
			jsr	DB_TestIconPos
...
if Flag64_128 = TRUE_C128
			ora	DB_DblBit		;Double-Bit für X setzen
endif
			sta	DB_Icon_Tab -6,x
