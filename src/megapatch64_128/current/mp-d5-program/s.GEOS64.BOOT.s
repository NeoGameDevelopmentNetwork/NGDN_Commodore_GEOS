...
::48			jsr	Strg_MgrSCPU		;Installationsmeldung ausgeben.
			...
			lda	#$30			;Standard-RAM-Bereiche einblenden.
			sta	CPU_DATA
...
:InitSys_GEOSVar	jsr	Strg_InitGEOS		;Installationsmeldung ausgeben.
			...
			ldx	#$ff			;Stack-Pointer löschen.
			txs
			lda	#$35			;I/O-Bereiche einblenden.
			sta	CPU_DATA
...
:SYSTEM_ROM_LOAD	lda	#$37			;GEOS-Bereich ausblenden.
			sta	CPU_DATA
			...
			lda	#$30			;GEOS-Bereich einblenden.
			sta	CPU_DATA
