...
;*** Icons.
:RIcon_Drive1		w IconDrive1
			b $00,$00,IconDrive1_x,IconDrive1_y
			b USE_COLOR_INPUT
...
:RIcon_Drive2		w IconDrive2
			b $00,$00,IconDrive2_x,IconDrive2_y
			b USE_COLOR_INPUT
...
:RIcon_Printer		w IconPrinter
			b $00,$00,IconPrinter_x,IconPrinter_y
			b USE_COLOR_INPUT
...
;*** Dateien zählen.
:countFiles		lda	fileEntryCount +0	;Anzahl Dateien >0 ?
...
::2			lda	#"P"			;PRG-Datei = ",P,..."
			...
			lda	#NULL			;IGNORE-Zähler zurücksetzen.
			sta	a3H
...
:SendFileData		jsr	LoadDataBuf		;Daten in Zwischenspeicher laden.
