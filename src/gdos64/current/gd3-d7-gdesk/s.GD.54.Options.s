...
if DEBUG_SYSINFO = FALSE
			b 6				;Anzahl Einträge ohne Debug.
endif
if DEBUG_SYSINFO = TRUE
			b 7				;Anzahl Einträge mit Debug.
endif
...
if DEBUG_SYSINFO = TRUE
:RCardIconX_9		= RCardIconX_6 + RTabIcon6_x
endif

;*** Menü-Icons.
:optIconNext		w IconNext
			b $00,$00,IconNext_x,IconNext_y
			b USE_COLOR_INPUT
...
:optIconSwitch		w IconSwitch
			b $00,$00,IconSwitch_x,IconSwitch_y
			b USE_COLOR_INPUT
...
;--- HotCorner-Symbole.
:optIconHC1		w IconHC1
			b $00,$00,IconHC1_x,IconHC1_y
			b USE_COLOR_REG
...
:optIconHC2		w IconHC2
			b $00,$00,IconHC2_x,IconHC2_y
			b USE_COLOR_REG
...
:optIconHC3		w IconHC3
			b $00,$00,IconHC3_x,IconHC3_y
			b USE_COLOR_REG
...
:optIconHC4		w IconHC4
			b $00,$00,IconHC4_x,IconHC4_y
			b USE_COLOR_REG
...
:optIconTitle		w IconHeader
			b $00,$00,IconHeader_x,IconHeader_y
			b USE_COLOR_REG
...
:R9T02			b "VLIR-MODULE IN GEODESK-RAM",NULL
