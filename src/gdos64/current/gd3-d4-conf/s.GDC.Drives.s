...
::3			jsr	SetADDR_Register	;Register-Routine einlesen.
			jsr	FetchRAM
...
::2			tya				;Fehlendes Laufwerk in
			...
			lda	#< Dlg_IllegalCfg	;"Konfiguration ungültig!"
			ldx	#> Dlg_IllegalCfg
...
::cont			jsr	SetRAM_TaskMan		;Speicher für TaskManager und
...
::2			lda	InstallDrvType
			...
			lda	dirEntryBuf +1 		;Tr/Se-Adresse Dateianfang
			sta	r1L			;einlesen.
			lda	dirEntryBuf +2
			sta	r1H
...
:SetDiskDatReg		LoadW	r0,BASE_DDRV_INFO
			LoadW	r1,$0000
...
:testDrvNames		lda	#< DRVINF_NG_NAMES
			...
			SubVW	3,r14			;Zeiger für Vergleich korrigieren.
...
::next			AddVBW	17,r14			;Zeiger auf nächsten Namen.
...
:iconSlctDisk		w Icon_25
			b $00,$00,Icon_25x,Icon_25y
			w :exit
...
:RegTName3		w Icon_24
			b RegCardIconX_3,$28,Icon_24x,Icon_24y

:RegTName4		w Icon_23
			b RegCardIconX_4,$28,Icon_23x,Icon_23y

:RegTName5		w Icon_22
			b RegCardIconX_5,$28,Icon_22x,Icon_22y

;*** System-Icons.
:RIcon_Select		w Icon_10
			b $00,$00,$01,$08
			b USE_COLOR_INPUT

:RIcon_Option		w Icon_11
			b $00,$00,$01,$08
			b USE_COLOR_REG
...
:RegTText3_02		b	$58,$00,$4e, "Load disk drivers into RAM "
			b GOTOXY,$58,$00,$56, "during startup",0
:RegTText3_03		b	$58,$00,$5e, "Load selected drivers to RAM",0
endif
...
:RegTText5_03		b	$48,$00,$6e, "RAMLink: Device address >=12:"
			...
			b GOTOXY,$48,$00,$9e, "address #8-11/A:-D:. If the system boots"
			b GOTOXY,$48,$00,$a6, "from a drive address >=12, then these"
			b GOTOXY,$48,$00,$ae, "options will control the boot beaviour.",0
endif
...
:RegCardIconX_4		= RegCardIconX_3 + Icon_24x
