...
:Inf_CopyExtras		b "Hintergrundbilder, Bildschirmschoner und"
			b GOTOXY
			w $0018
			b $7a
			b "und Farbprofile werden kopiert...",NULL
...
:Inf_CopyExtras		b "Copying wallpapers, screen savers and"
			b GOTOXY
			w $0018
			b $7a
			b "color profiles...",NULL
...
if LANG = LANG_EN
			b "This program will help you to install GDOS64"
endif
			b GOTOXY
			w $0010
			b $70
...
if LANG = LANG_EN
			...
			b $7c
if LANG = LANG_DE
			b "Hinweis: SuperCPU / TurboChameleon64 empfohlen!"
endif
if LANG = LANG_EN
			b "Note: SuperCPU / TurboChameleon64 recommended!"
endif
			b GOTOXY
			w $0010
			b $88
...
if LANG = LANG_EN
			b "GDOS64. Should the existing system files"
endif
			b GOTOXY
			w $0018
			b $68
...
if LANG = LANG_EN
			...
			b $78
if LANG = LANG_DE
			b "Nach der Überprüfung wird GDOS64 installiert"
endif
if LANG = LANG_EN
			b "After this is done GDOS64 will be installed"
endif
			b GOTOXY
			w $0018
			b $80
...
:txNoREU		b PLAINTEXT
			...
			b $58
if LANG = LANG_DE
			b "Die ausgewählten GDOS64-Systemdateien"
endif
if LANG = LANG_EN
			b "The selected GDOS64 system files have"
endif
			b GOTOXY
			w $0018
			b $60
...
:txAllDone1		b PLAINTEXT
			...
			b $58
if LANG = LANG_DE
			b "Die Diskette wurde überprüft und alle"
endif
if LANG = LANG_EN
			b "The bootdisk was checked and all GDOS64"
endif
			b GOTOXY
			w $0018
			b $60
if LANG = LANG_DE
			b "GDOS64-Dateien sind vorhanden."
endif
if LANG = LANG_EN
