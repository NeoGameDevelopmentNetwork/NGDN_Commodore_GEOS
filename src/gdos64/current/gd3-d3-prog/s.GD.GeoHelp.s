...
:LoadAdress = $3c00 ;Ladeadresse für GeoWrite-Seite.

;Seitengröße von $3C00 - $5FFF.
;GeoWrite verwaltet Seiten mit
;6683 Zeichen = $1A1B Bytes.
endif
...
;*** Variablen initialisieren.
			...
			jsr	InitHelpFile		;Erste Seite suchen.
			txa				;Fehler ?
...
::stdhelp		LoadW	r0,HelpFirstPage	;Name der System-Hilfedatei
			LoadW	r1,Help001		;übertragen.
			jsr	SetHelpFile
			txa				;Name gültig ?
			bne	:errFile		; => Nein, Abbruch...
...
::loadhelp		pha
			...
			LoadW	r0,NewHelpFile		;Name der System-Hilfedatei
			LoadW	r1,dirEntryBuf +3	;übertragen.
			jsr	SetHelpFile
...
::std			jsr	OpenDisk		;Diskette öffnen.
			txa				;Diskettenfehler ?
			bne	:err			; => Ja, Ende...
...
:InitHelpFile		LoadW	r0,HelpFirstPage	;Name der System-Hilfedatei
			LoadW	r1,HelpSystemFile	;übertragen.
			jsr	SetHelpFile
			txa				;Name gültig ?
			bne	:exit			; => Nein, Ende...
...
:SetOrgCol		jsr	InitForIO		;I/O-Bereich einblenden.
...
:SetPrntData1		jsr	InitForIO		;I/O-Bereich einblenden.
			LoadB	$d020,$00		;Farbe für Rahmen/Mauszeiger setzen.
			LoadB	$d027,$0d
			jsr	DoneWithIO		;I/O-Bereich ausblenden.
...
:LoadHelpIndex		jsr	WaitNoMseKey		;Maustaste abwarten.
...
;*** Endadresse testen.
;******************************************************************************
			g LOAD_HELPSYS + RHS_HELPSYS -1
;******************************************************************************

;*** Speicher für Hilfeseite.
;    Beginnt immer ab $xy00 <= Wichtig!
:DATA_BASE
:HelpTextMem		= (DATA_BASE / 256 +1) * 256
