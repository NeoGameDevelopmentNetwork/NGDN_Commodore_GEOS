...
:WIN_FILES		b $00				;$00 = Standardfenster
			...
			w INIT_WIN_DATA			;Neues Fenster initialisieren.
							;(z.B. 64K-Bank für Datei-Cache suchen)
			w $ffff				;Routine zur Ausgabe der Daten.
...
;--- Hinweis:
;d1/d2/d3 werden über ":INIT_WIN_DATA"
;initialisiert/überschrieben.
::_d1			w $ffff				;Routine für Mehrfachauswahl.
							;$0000=Nicht möglich, $ffff=Standard.
::_d2			w $ffff				;Routine für Einzelauswahl.
							;$0000=Nicht möglich, $ffff=Standard.

			w GD_PRINT_ENTRY		;Routine zur Ausgabe eines Eintrages.
::_d3			w GD_GET_DATA			;Dateieinträge einlesen.
