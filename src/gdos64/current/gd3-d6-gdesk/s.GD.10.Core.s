...
.MOD_OPEN_PAINT		lda	#$1e			;GEOS/Paint-Dokument auswählen.
			b $2c
.MOD_OPEN_EXITG		lda	#$21			;GEOS/nach GEOS verlassen.
			b $2c
.MOD_OPEN_EXIT64	lda	#$24			;GEOS/nach BASIC verlassen.
			b $2c
.MOD_OPEN_EXITB		lda	#$27			;GEOS/BASIC-Programm auswählen.
			b $2c
.MOD_OPEN_DA		lda	#$2a			;GEOS-Hilfsmittel auswählen.
			b $2c
.MOD_FIND_ALFILE	lda	#$2d			;AppLink-Datei suchen.
			ldx	#GMOD_FILE_OPEN
			jmp	EXEC_MODULE
...
;    Speicher nachladen.
:GET_MODULE		sta	GD_VLIR_ACTIVE		;Modul-Nummer speichern.
...
::default		ldx	#< VLIR_BASE		;Alle anderen VLIR-Module:
...
.BACKUP_CURMOD		ldy	GD_VLIR_ACTIVE		;Aktuelles VLIR-Modul sichern.
			b $2c
