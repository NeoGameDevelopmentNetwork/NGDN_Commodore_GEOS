...
:OpenFileMenu		lda	#5!VERTICAL		;Anzahl Menüeinträge zurücksetzen.
			...
			MoveW	fileEntryVec,r0		;Ausgewählte Datei nach ":r0".
...
::next			AddVBW	32,r4			;Alle Dateien durchsucht?
...
::no_filecvt		lda	#ITALICON
			...
			LoadW	r0,menuFile		;Dateimenü.
			LoadB	r5H,widthFileMenu
			jsr	MENU_SET_SIZE
			jmp	OPEN_MENU

;--- Gelöschte Dateien.
::1			LoadW	r0,menuDeleted		;Menü für gelöschte Dateien.
			LoadB	r5H,widthDeleted
			jsr	MENU_SET_SIZE
			jmp	OPEN_MENU
...
:ROUT_SENDTO		LoadW	r0,menuSub_Send		; -> Senden an...
			LoadB	r5H,widthSub_Send
			jsr	MENU_SET_SIZE
			jmp	MENU_SETINT_r0
