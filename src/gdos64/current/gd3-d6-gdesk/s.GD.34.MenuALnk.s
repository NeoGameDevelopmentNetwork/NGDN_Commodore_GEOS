...
;--- Rechter Mausklick auf AppLink/Laufwerk/CMD/SD.
			LoadW	r0,menuAL_SDCMD
			LoadB	r5H,widthAL_SDCMD
			jsr	MENU_SET_SIZE
			jmp	OPEN_MENU

;--- Rechter Mausklick auf AppLink/Laufwerk/Std.
::2			LoadW	r0,menuAL_Drive
			LoadB	r5H,widthAL_Drive
			jsr	MENU_SET_SIZE
			jmp	OPEN_MENU

;--- Rechter Mausklick auf AppLink/Datei.
::4			LoadW	r0,menuAL_File
			LoadB	r5H,widthAL_File
			jsr	MENU_SET_SIZE
			jmp	OPEN_MENU

;--- Rechter Mausklick auf AppLink/Arbeitsplatz.
::5			LoadW	r0,menuMyComp
			LoadB	r5H,widthMyComp
			jsr	MENU_SET_SIZE
			jmp	OPEN_MENU

;--- Rechter Mausklick auf AppLink/Drucker.
::6			LoadW	r0,menuAL_Prnt
			LoadB	r5H,widthAL_Prnt
			jsr	MENU_SET_SIZE
			jmp	OPEN_MENU

;--- Rechter Mausklick auf AppLink/Verzeichnis.
::7			LoadW	r0,menuAL_SDir
			LoadB	r5H,widthAL_SDir
			jsr	MENU_SET_SIZE
			jmp	OPEN_MENU
