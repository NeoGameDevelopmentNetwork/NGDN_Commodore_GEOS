...
;MegaAssemvbler V3/V4:	TRUE
:newMegaAss = TRUE

;Hinweis:
;MegaAssembler V3/V4 enthält den
...
:MAIN			jsr	i_MoveData		;Dialogbox-Daten zwischenspeichern.
			w	dlgBoxRamBuf
			w	dlgBoxCopyBuf
			w	417
...
:LoadApplication	LoadW	r6,FNameBuf		;Zeiger auf Dateiname.
			LoadB	r0L,$00			;Programm laden und starten.
			jsr	GetFile			;Bei Fehler zurück zur Anwendung.
...
;
:FindApplication	lda	curDrive		;Laufwerk speichern.
			sta	curDeviceBuf

::search_file		LoadB	r7L,APPLICATION		;GEOS-DateiTyp.
...
::3			cpx	curDeviceBuf
			...
			beq	:search_file		; => Nein, Anwendung suchen.
...
if newMegaAss = TRUE
:Class_MegaAss		b "MegaAss     V",NULL		;MegaAssembler V3/V4.
endif
