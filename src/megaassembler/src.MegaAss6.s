...
;*** Diskette wechseln.
:ChangeDisk		lda	Opt_SourceDrive
			cmp	Opt_BootDrive		;Diskwechsel möglich ?
			bne	:1			;Nein, Abbruch...
			jmp	ReDoMenu

::1			jsr	GotoFirstMenu		;Hauptmenü aktivieren.
...
:Word40_Data		w DM_MainMenu+4 ,$009d
			...
			w DM_Parameter+4 ,$00ba
			w DM_SlctDrive+2 ,$0080
...
:Word80_Data		w DM_MainMenu+4 ,$00d4
			...
			w DM_Parameter+4 ,$00f0
			w DM_SlctDrive+2 ,$00a0
			w DM_SlctDrive+4 ,$0117
...
:MT04b			b PLAINTEXT,"Diskette wechseln",PLAINTEXT,NULL
